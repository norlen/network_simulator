...
public class Run {
    public static void main(String[] args) {
        //Creates two links
        Link link1 = new LossyLink(10, 1, 0);
        Link link2 = new LossyLink(10, 1, 0);
        ...
        var dst = new NetworkAddr(2, 2);
        var TrafficGenerator = new TrafficGenerator(host1);
        TrafficGenerator.StartSending(dst);
